...
const ExportDataButton = ({ filters }: Props) => {
    ...
    return (
        <a
            href={href}
            className="h-10 flex justify-center gap-2 font-body m-2 p-2 bg-white border-2 border-green-500 rounded-lg text-green-600 hover:bg-gray-100 font-bold shadow-md">
            <svg className="fill-green-600" height="22px" width="22px" role="img" viewBox="0 0 576 512">
